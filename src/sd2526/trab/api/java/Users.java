...
public interface Users {
	 ...
	 * 
	 * The operation succeeds when the name is not already in use; or, when the same
	 * user is already present in the system.
	 * 
	 * @param user - User to be created
	 * @return (OK, the address of the user: name@domain)
	 *         FORBIDDEN if the domain in the user does not match the domain of the
	 *         server;
	 *         CONFLICT if the name is already associated with a different user
	 *         (i.e., password or display name differ);
	 ...
	 * 
	 * @return (OK, the user object, if the name exists and pwd matches the existing
	 *         password)
	...
	/**
	 * Modifies the information of a user. Any field of the provided info containing
	 * null should
	 ...
	 * All resources owned by this user in other services should also be eventually
	 * released, without waiting for completion.
	 * 
	 * @param name - the name of the user
	 * @param pwd  - password of the user
