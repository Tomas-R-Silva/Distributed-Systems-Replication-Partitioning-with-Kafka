...
public interface Messages {
	 ...
	 * an ID, and by changing the sender to be in the format "display name
	 * <name@domain>".
	 * 
	 ...
	 * (see grading for how addressing this feature is valued).
	 * 
	...
	// Internal stuff
	Result<Void> deliverInternal(Message message);

	Result<Void> deleteInternal(String mid);
}
